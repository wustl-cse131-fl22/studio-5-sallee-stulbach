...
public class Methods {
	...
	public static String substituteAll(String source, char target, String replacement) {
		...
		{
			// char substring = source.substring(i, i + 1);
			if (ch[i] == (target))
			{
				result += replacement;
			}
	...
	/**
	 * Return integer value of mean of all values in given array
	 * @param array   array of values to calculate their mean
	 * @return integer that is the mean
	 */
